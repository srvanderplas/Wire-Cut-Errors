...
%DIF DEL index-old.tex   Tue Feb  6 08:14:32 2024
...
\DIFdelbegin \DIFdel{\svp{As database size increases, so does the probability of finding a close non-match.}
}\DIFdelend \DIFaddbegin \DIFadd{As database size increases, so does the probability of finding a close non-match.
}\DIFaddend 
...
\DIFdelbegin \DIFdel{\svp{different tool designs have between 2 and 4 cutting surfaces in contact with the substrate.}
%DIF <  depending on the tool design, there can be between two and four cutting surfaces in contact with the substrate.
}\DIFdelend \DIFaddbegin \DIFadd{different tool designs have between 2 and 4 cutting surfaces in contact with the substrate.
}\DIFaddend 
...
comparisons.
Examiners would make cuts under multiple angles \citep{baikerToolmarkVariabilityQuality2015}, increasing the number of comparisons \DIFdelbegin \DIFdel{\svp{and making a} false identification even more \svp{probable}}\DIFdelend \DIFaddbegin \DIFadd{and making a false discovery even more probable}\DIFaddend .
...
\DIFdelbegin \DIFdel{\svp{Clearly, studies for wire evidence, and larger studies for striated evidence in general, are necessary.}
%DIF <  \hh{Obviously, we need studies for wire evidence. It is also clear, based on the error rates, that larger studies are needed. }
...
%DIF <  \hh{Going forward, we need to move away from  the binary assessment of 'match' or 'non-match' and quantify (a) the similarity of striations expressed between two pieces of evidence, and (b) the frequency of the observed pattern. Unusual striation patterns should be assigned more weight in the process.  }
}\DIFdelend \DIFaddbegin \DIFadd{Clearly, studies for wire evidence, and larger studies for striated evidence in general, are necessary.
