...
The blade cuts will then be compared to the wire under a comparison microscope in a process shown in \Cref{fig:wire-blade}, though eventually, automatic comparison algorithms may also be validated for lab use.
